  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-primary to-accent text-primary-foreground hover:shadow-lg transform hover:-translate-y-0.5 transition-bounce font-semibold",
        success: "bg-success text-success-foreground hover:bg-success/90 shadow-md",
        analytics: "bg-analytics text-analytics-foreground hover:bg-analytics/90 shadow-md",
        interview: "interview-gradient text-white hover:shadow-interview transform hover:scale-105 transition-bounce font-medium",
      },
      size: {
